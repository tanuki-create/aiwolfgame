...
export class PrivateContextBuilder {
  private publicBuilder: PublicContextBuilder;
...
export class WolfChatContextBuilder {
  ...
  build(state: GameState, wolfId: string, isLeader: boolean): string {
    ...
    if (!wolf) throw new Error('Wolf not found');
...
export class MessageBuilder {
  ...
  addChatHistory(messages: LLMMessage[], history: Array<{ speaker: string; text: string }>): LLMMessage[] {
